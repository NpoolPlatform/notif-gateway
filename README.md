...
[![Test](https://github.com/NpoolPlatform/notif-gateway/actions/workflows/main.yml/badge.svg?branch=master)](https://github.com/NpoolPlatform/notif-gateway/actions/workflows/main.yml)
...
* make notif-gateway ```单独编译服务```
* make notif-gateway-image ```单独生成服务镜像```
